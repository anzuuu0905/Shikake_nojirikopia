      ...
      <div class="tsw">
        <p class="logo">
          <a href="<?php echo home_url(''); ?>">
            <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/logo_black.svg" alt="【公式】のじりこぴあ">
            <img class="white" src="<?php echo get_template_directory_uri(); ?>/img/logo_white.svg" alt="【公式】のじりこぴあ">
          </a>
        </p>
